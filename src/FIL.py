...
def display_menu(config):
    ...
    elif config.system_name == 'Darwin':  # 'Darwin' est le nom de base de macOS
        subprocess.run(["clear"])  # Utilisez la commande 'clear' pour effacer la console sur macOS
    else:
        # Gérer les autres systèmes d'exploitation ici si nécessaire
        print("Unsupported operating system for console clearing.")
